...
const Card = ({ description, votes, option1, option2, deadline, id }: Card) => {
  ...
  // function to convert bet to usd 1 ETH = 3100 USD only last two decimal
    ...
    <div className="flex flex-col w-[25rem] h-[14rem] bg-[#141414] bg-opacity-70 border border-neutral-800 backdrop-filter backdrop-blur-sm rounded-xl shadow-md p-6 justify-between">
      ...
      {!trade ? (
        ...
        <div className="flex flex-col w-full gap-4">
          ...
          <button className="w-full text-neutral-900 hover:text-neutral-800 bg-gradient-to-tr from-[#f0ffad] to-lime-300 hover:from-lime-200 hover:to-lime-300 rounded-lg px-5 py-2.5 text-center font-medium shadow disabled:opacity-75 disabled:cursor-progress">
