    ...
    <nav className="fixed top-0 left-0 right-0 z-50 backdrop-filter backdrop-blur-md mx-5 md:mx-20 lg:mx-28 xl:mx-36 2xl:44 md:px-10 my-2 border border-neutral-300 bg-[#ffe1b1] rounded-[3rem]">
      <div className="max-w-screen-3xl flex flex-wrap items-center justify-between px-4 py-2">
        <div className="flex">
          <Link
            href="/"
            className="flex flex-row gap-2 items-end text-2xl text-transparent bg-clip-text bg-gradient-to-b from-violet-500 from-[20%] to-violet-600 font-title font-semibold cursor-pointer whitespace-nowrap"
          >
            <Image src="/wisebets.png" alt="logo" width={40} height={40} className="w-12 h-10" />
            WiseBets
          </Link>
        </div>
        <button
